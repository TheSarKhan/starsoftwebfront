...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "biznes analitika Azərbaycan",
    "telegram bot sifarişi",
    "IT xidmətləri Bakı",
  ],
  alternates: { canonical: "https://starsoft.az/services" },
  openGraph: {
    title: "Xidmətlər | StarSoft",
    description: "Web, mobil, kibertəhlükəsizlik, infrastruktur, avtomatlaşdırma, analitika, Telegram bot — Bakıda, bir əldən.",
